...
def find_most_similar_case(input_text, model, tokenizer, cases, file_names):
    ...
    return file_names[most_similar_idx], similarities[most_similar_idx]
...
# 유사한 판례 찾기
similar_case, similarity_score = find_most_similar_case(input_text, model, tokenizer, cases, file_names)
